...
from cameraType.ros_camera import *
from cameraType.realsense import *

from bugcar_image_segmentation.utils import order_points_counter_clockwise,clahe
import argparse
...
if __name__ == "__main__":
    ...
    camera = ROSCamera(input_topic, camera_calibration_file)
    try:
...
#             # ================================================
            ...
            if rvec is not None:
                ...
                for rotation in rvec:
                    ...
                    print(R.from_matrix(rotation_mat_fid2cam).as_euler("xyz",degrees=True))
